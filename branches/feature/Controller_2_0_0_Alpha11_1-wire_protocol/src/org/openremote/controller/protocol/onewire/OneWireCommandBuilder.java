...
//    private final static Logger logger = Logger.getLogger(ONEWIRE_PROTOCOL_LOG_CATEGORY);
    private final static Logger logger = Logger.getLogger(OneWireCommandBuilder.class);


    private static final int INT_DEFAULT_OWSERVER_PORT = 4304;
    private static final String STR_ATTRIBUTE_NAME_HOSTNAME = "hostname";
    private static final String STR_ATTRIBUTE_NAME_PORT = "port";
    private static final String STR_ATTRIBUTE_NAME_DEVICE_ADDRESS = "deviceAddress";
    private static final String STR_ATTRIBUTE_NAME_FILENAME = "filename";
    private static final String STR_ATTRIBUTE_NAME_REFRESH_TIME = "refreshTime";
