package org.openremote.modeller.client;

import java.util.List;

import org.openremote.modeller.client.rpc.MyService;
import org.openremote.modeller.client.rpc.MyServiceAsync;
import org.openremote.modeller.domain.Activity;
import org.openremote.modeller.domain.Screen;
 ...
 */
public class Modeller implements EntryPoint {
         ...
         public void onSuccess(List<Activity> activities) {
            for (Activity activity : activities) {
               ...
               for (Screen screen : activity.getScreens()) {
                  System.out.println("screen " + screen.getName() + " in "+activity.getOid());
               }
               imagePanel.add(html);
            }
