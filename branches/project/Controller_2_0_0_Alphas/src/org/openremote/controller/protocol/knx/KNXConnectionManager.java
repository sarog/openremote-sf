...
//       * IMPLEMENTATION NOTE:
//       *
//       *   Assumption here is still DPT 1.001 only !
//       */
//
//      // TODO : KNX datapoints
//
//      // DPT 1.001 (1-bit boolean)
//      final int DATATYPE_BOOLEAN_BIT_ON   = 0x01;
//      final int DATATYPE_BOOLEAN_BIT_OFF  = 0x00;
//
//      //ApplicationProtocolDataUnit.Service applicationLayerService =
//      //    ApplicationProtocolDataUnit.Service.GROUPVALUE_WRITE;
//
//      byte data = 0x00;
//
//      switch (command)
...
//        case SWITCH_ON:
//
//          data = DATATYPE_BOOLEAN_BIT_ON;
//
//          break;
//
//        case SWITCH_OFF:
//
//          data = DATATYPE_BOOLEAN_BIT_OFF;
//
//          break;
//
//        default:
...
//      }
//
//      //ApplicationProtocolDataUnit apdu = new ApplicationProtocolDataUnit(applicationLayerService, data);
//
//      this.send(command);
//    }
//
...
//      byte data = 0x00;
//
//      //ApplicationProtocolDataUnit apdu = new ApplicationProtocolDataUnit(
//      //    ApplicationProtocolDataUnit.Service.GROUPVALUE_READ,
//      //    data
//      //);
//
//      this.send(command);
...
//      }
      ...
      //byte[] destAddress = command.getDestinationAddressBytes();
...
//                destAddress[0],                // Destination Address
//                destAddress[1],
...
//    {
//
//      connection.addConnectionListener(new KNXListener()
//      {
//        public void frameReceived(FrameEvent event)
//        {
//          System.out.println("------ KNX FRAME RECEIVED: " + event.getFrame());
...
//            {
//                0x11,        // Message Code
//                0x00,       // Additional Info Length - 0x00 no additional data
//                (byte)(STANDARD_FRAME_TYPE +     // Control Field 1 - 0x86
//                      REPEAT_FRAME +
//                      SYSTEM_BROADCAST +
//                      NORMAL_PRIORITY +
//                      REQUEST_ACK),
//                (byte)(GROUP_ADDRESS +           // Control Field 2 - 0xE0
//                      HOP_COUNT +
//                      NON_EXTENDED_FRAME_FORMAT),
//                0x00,          // Source Address -- all zeroes
//                0x00,
