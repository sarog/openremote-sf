...
/**
 * This class is responsible for testing IpUtil.
 * 
...
public class IpUtilTest extends TestCase {
	...
	public void testIpStringToLong() {
		long ipLong = IpUitl.ipStringToLong("80.35.83.10");
		Assert.assertEquals(1344492298, ipLong);
	}	
	
	public void testIpLongToString() {
		String ipString = IpUitl.ipLongToString(1344492298);
		Assert.assertEquals("80.35.83.10", ipString);
	}
	
	public void testSplitIpFromURL() {
		String ip1 = IpUitl.splitIpFromURL("http://192.168.100.34:8080/controller");
		Assert.assertEquals("192.168.100.34", ip1);
		String ip2 = IpUitl.splitIpFromURL("http://192.168.100.34/controller");
		Assert.assertEquals("192.168.100.34", ip2);
		String ip3 = IpUitl.splitIpFromURL("http://192.168.100.34/");
		Assert.assertEquals(null, ip3);
		String ip4 = IpUitl.splitIpFromURL("http://192.168.100.34/");
