...
import org.openremote.beehive.api.dto.modeler.CommandDelayDTO;
...
public class CommandDelay extends DeviceMacroItem {
   ...
   public DeviceMacroItemDTO toDTO() {
      CommandDelayDTO deviceMacroItemDTO = new CommandDelayDTO();
      deviceMacroItemDTO.setId(getOid());
      deviceMacroItemDTO.setDelaySecond(delaySecond);
