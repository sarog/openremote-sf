...
/**
 * Controller for Beehive database UI Interface
 * User: allenwei
 * Date: 2009-2-11
 * Time: 17:27:22
 */
public class BeehiveDatabaseController extends MultiActionController {
     ...
     * @param response HttpServletResponse
     * @return ModelAndView
     * @throws ServletRequestBindingException Exception occured when missing vendor id parameter
     */
    public ModelAndView showModelSelect(HttpServletRequest request,
     ...
     * @param response HttpServletResponse
     * @return ModelAndView
     * @throws ServletRequestBindingException Exception occured when missing model id parameter
     */
    public ModelAndView showRemoteSelect(HttpServletRequest request,
                                         HttpServletResponse response) throws ServletRequestBindingException {
        ModelAndView mav = new ModelAndView(cmpSelectContainer);
        String generateSelectTcagId = ServletRequestUtils.getRequiredStringParameter(request, "generateSelectTcagId");
     ...
     * @throws ServletRequestBindingException Exception occured when missing model id parameter
     */
    public ModelAndView showLircDetailByModel(HttpServletRequest request,
                                              HttpServletResponse response) throws ServletRequestBindingException {
     ...
     * @param response HttpServletResponse
     * @return ModelAndView
     * @throws ServletRequestBindingException Exception occured when missing section id parameter
     */
    public ModelAndView showLircDetailByRemoteSection(HttpServletRequest request,
                                                      HttpServletResponse response) throws ServletRequestBindingException {
        ModelAndView mav = new ModelAndView(cmpLircDetails);
     ...
     * @throws ServletRequestBindingException Exception occured when missing model id parameter
     */
    public ModelAndView isMutiSection(HttpServletRequest request,
