...
function afterSelectVendor(vendor_id) {
    if (vendor_id != 0) {
        myAjaxCall("beehiveDatabase.htm", {method:"showModelSelect",generateSelectTcagId:MODEL_SELECT,vendorId:vendor_id}, function (html) {
...
function afterSelectModel(model_id) {
    if (model_id != 0) {
        myAjaxCall("beehiveDatabase.htm", {method:"isMutiSection",modelId:model_id}, function (result) {
            if (result == "true") {
                $.get("beehiveDatabase.htm", {method:"showRemoteSelect",generateSelectTcagId:REMOTE_SELECT,modelId:model_id}, function (html) {
...
function showLircDetailByModel(model_id) {
    myAjaxCall("beehiveDatabase.htm", {method:"showLircDetailByModel",modelId:model_id}, function (html) {
        fillLircDetail(html);
    });
}
...
function showLircDetailsByRemote(remote_id) {
    if (remote_id != 0) {
        myAjaxCall("beehiveDatabase.htm", {method:"showLircDetailByRemoteSection",sectionId:remote_id}, function (html) {
            fillLircDetail(html);
