...
/*
 return local host address as UInt32
 */
- (UInt32)localHostAsInteger
{
	if(theSocket4)
	{
		...
		if(getsockname(CFSocketGetNative(theSocket4), (struct sockaddr *)&sockaddr4, &sockaddr4len) < 0)
		{
			return 0;
		}
		return ntohl(*(UInt32 *)&(sockaddr4.sin_addr));
	}
	else
		return 0;
}
