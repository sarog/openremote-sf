...
function getVersionLabel() {
    ...
    var headUrl = "$HeadURL: https://svn.code.sf.net/p/openremote/code/workspace/juha/Controller_2_1_0_FeatureMergeBranch/web/js/index.js $";
    var revision = "$Revision: 8495 $";
    var result = "Untagged";
    var verStr = "";
    var tagStart = -1;
