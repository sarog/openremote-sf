...
public class DimensionResponseCmd extends CommandOPEN
{
    ...
    {
        super(commandString, 5, who, where);
     ...
     * @param values values of the specified dimension
     */
    public DimensionResponseCmd(String who, String where, String dimension, String values)
    {
        super("*#" + who + "*" + where + "*" + dimension + values + "##", 5, who, where);
        this.dimension = dimension;
        this.values = values.split("\\*");
    }
    /**
     ...
     */
    public DimensionResponseCmd(String commandString)
    {
        super(commandString, 5, "", "");
