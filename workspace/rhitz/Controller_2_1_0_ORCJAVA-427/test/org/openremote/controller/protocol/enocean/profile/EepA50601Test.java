...
public class EepA50601Test
{
  ...
  @Test public void testBasicConstruction() throws Exception
  {
    ...
    Eep eep = EepType.lookup("A5-06-01").createEep(
        deviceID, Constants.ILLUMINATION_STATUS_COMMAND, null
    );

    Assert.assertTrue(eep instanceof EepA50601);
    Assert.assertEquals(EepType.EEP_TYPE_A50601, eep.getType());

    // Old EEP number ...

    eep = EepType.lookup("07-06-01").createEep(
        deviceID, Constants.ILLUMINATION_STATUS_COMMAND, null
    );
  ...
  {
    EepA50601 eep = (EepA50601)EepType.lookup("A5-06-01").createEep(
        deviceID, Constants.ILLUMINATION_STATUS_COMMAND, null
    );
    ...
    Assert.assertEquals(Double.valueOf(600), eep.getIllumination1());
    ...
    Assert.assertTrue(isUpdate);
    Assert.assertEquals(Double.valueOf(60000), eep.getIllumination1());
  ...
  @Test public void testUpdateIllumination2() throws Exception
  {
    ...
    Assert.assertTrue(isUpdate);
    Assert.assertEquals(Double.valueOf(300), eep.getIllumination2());
    ...
    Assert.assertTrue(isUpdate);
    Assert.assertEquals(Double.valueOf(30000), eep.getIllumination2());
  ...
  {
    EepA50601 eep = (EepA50601)EepType.lookup("A5-06-01").createEep(
        deviceID, Constants.SUPPLY_VOLTAGE_STATUS_COMMAND, null
    );
