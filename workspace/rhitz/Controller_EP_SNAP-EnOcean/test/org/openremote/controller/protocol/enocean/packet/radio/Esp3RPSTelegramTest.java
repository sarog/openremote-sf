...
public class Esp3RPSTelegramTest
{
  ...
  {
    Esp3RPSTelegram telegram = new Esp3RPSTelegram(senderID, payload, status);

    assertTelegramAttributes(telegram, senderID, payload, status);


    telegram = new Esp3RPSTelegram(telegram.getData(), telegram.getOptionalData());
  ...
  @Test public void testSenderID() throws Exception
  {
    ...
    telegram = new Esp3RPSTelegram(senderID, payload, status);
  ...
  {
    Esp3RPSTelegram telegram = new Esp3RPSTelegram(null, payload, status);
  }
  ...
  public void testNullArg2() throws Exception
  {
    ...
    telegram = new Esp3RPSTelegram(null, telegram.getOptionalData());
  }
  ...
  public void testNullArg3() throws Exception
  {
    ...
    telegram = new Esp3RPSTelegram(telegram.getData(), null);
  }
  ...
  public void testInvalidRORG() throws Exception
  {
    ...
    dataBytes[AbstractEsp3RadioTelegram.ESP3_RADIO_RORG_INDEX] =
        AbstractEsp3RadioTelegram.RORG.BS1.getValue();

    telegram = new Esp3RPSTelegram(dataBytes, telegram.getOptionalData());
  }
  ...
  public void testInvalidDataGroupLength() throws Exception
  {
    ...
    telegram = new Esp3RPSTelegram(dataBytesTooLong, telegram.getOptionalData());
  }
  ...
  public void testInvalidOptDataGroupLength() throws Exception
  {
    ...
    telegram = new Esp3RPSTelegram(telegram.getData(), optDataBytesTooLong);
  }
  ...
  private void assertTelegramAttributes(Esp3RPSTelegram telegram, DeviceID senderID,
                                        byte payload, byte status)
  {
    Assert.assertEquals(Esp3PacketHeader.PacketType.RADIO, telegram.getPacketType());
    Assert.assertEquals(AbstractEsp3RadioTelegram.RORG.RPS, telegram.getRORG());
  ...
  private byte[] createDataGroup(DeviceID deviceID, byte payload, byte status)
  {
    ...
    dataGroupBytes[0] = AbstractEsp3RadioTelegram.RORG.RPS.getValue();
