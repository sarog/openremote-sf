...
public class Esp21BSTelegramTest
{
  ...
  @Test public void testBasicConstruction() throws Exception
  {
    ...
    telegram = new Esp21BSTelegram(telegram.getData());
  ...
  {
    byte[] data = null;
    Esp21BSTelegram telegram = new Esp21BSTelegram(data);
  }
  ...
  public void testInvalidRORG() throws Exception
  {
    ...
    telegram = new Esp21BSTelegram(dataBytes);
  }
  ...
  public void testInvalidDataGroupLength() throws Exception
  {
    ...
    telegram = new Esp21BSTelegram(dataBytesTooLong);
  }
