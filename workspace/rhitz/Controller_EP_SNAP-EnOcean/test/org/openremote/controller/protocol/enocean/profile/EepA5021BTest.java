...
/**
 * Unit tests for {@link EepA5021B} class.
 *
 * @author Rainer Hitz
 */
public class EepA5021BTest extends EepA502XXTest
{
  ...
  {
    EepA5021B eep = (EepA5021B)EepType.lookup("A5-02-1B").createEep(
        deviceID, Constants.TEMPERATURE_STATUS_COMMAND
    );
    ...
    Assert.assertTrue(isUpdate);
    Assert.assertEquals(Double.valueOf(130), eep.getTemperature(), 0.0);
  }
