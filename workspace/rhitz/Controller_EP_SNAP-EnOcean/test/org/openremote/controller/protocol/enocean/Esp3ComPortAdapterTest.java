...
public class Esp3ComPortAdapterTest
{
  ...
  {
    Esp3ComPortAdapter portAdapter = new Esp3ComPortAdapter(mockPort, portConfig);
  ...
  {
    Esp3ComPortAdapter portAdapter = new Esp3ComPortAdapter(portConfig);
  ...
  {
    Esp3ComPortAdapter portAdapter = new Esp3ComPortAdapter(null, portConfig);
  }

  @Test (expected = IllegalArgumentException.class)
  public void testConstructorNullArg2() throws Exception
  {
    Esp3ComPortAdapter portAdapter = new Esp3ComPortAdapter(mockPort, null);
  }
