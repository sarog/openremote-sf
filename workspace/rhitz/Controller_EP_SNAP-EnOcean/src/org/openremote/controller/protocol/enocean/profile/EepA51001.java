 ...
 * @author Rainer Hitz
 */
public class EepA51001 extends EepA510XX
{
   ...
   */
  static final int EEP_A51001_FAN_OFFSET = 0;

  /**
   * Bit offset of 'set point' data field.
   */
  static final int EEP_A51001_SP_OFFSET = 8;

  /**
   * Bit offset of temperature data field.
   */
  static final int EEP_A51001_TMP_OFFSET = 16;

  /**
   * Bit offset of occupancy data field.
   */
  static final int EEP_A51001_OCC_OFFSET = 31;


  // Constructors ---------------------------------------------------------------------------------

  public EepA51001(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(EepType.EEP_TYPE_A51001, deviceID);

    initCommand(commandString);

    this.fanSpeed = createFanSpeedRange(EEP_A51001_FAN_OFFSET);
    this.setPoint = createSetPointRange8Bit(EEP_A51001_SP_OFFSET);
    this.temperature = createTemperatureRange8Bit(EEP_A51001_TMP_OFFSET);
    this.occupancy = createOccupancyBool(EEP_A51001_OCC_OFFSET);

    this.sensorData = new EepData(EepType.EEP_TYPE_A51001, 4, fanSpeed, setPoint, temperature, occupancy);
  }
