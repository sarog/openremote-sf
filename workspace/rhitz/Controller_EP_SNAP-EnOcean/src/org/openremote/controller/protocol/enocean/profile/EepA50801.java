...
/**
 * Represents the EnOcean equipment profile (EEP) 'A5-08-01'. <p>
 *
 * <pre>
 *
 *     +------+------+----------------------------------------------+
 ...
 *     +------+------+----------------------------------------------+
 *     | TYPE |  01  |Range 0lx to 510lx, 0°C to +51°C and Occupancy|
 *     +------+------+----------------------------------------------+
 *
 * </pre>
 *
 * The 'A5-08-01' profile data is transmitted by means of 4BS radio telegrams.
 ...
 * @author Rainer Hitz
 */
public class EepA50801 extends EepA508XX
{
   ...
   */
  static final double EEP_A50801_ILL_UNITS_DATA_RANGE_MIN = 0;

  /**
   * End of scaled illumination value range.
   */
  static final double EEP_A50801_ILL_UNITS_DATA_RANGE_MAX = 510;

  /**
   * Begin of scaled temperature value range.
   */
  static final double EEP_A50801_TMP_UNITS_DATA_RANGE_MIN = 0;

  /**
   * End of scaled temperature value range.
   */
  static final double EEP_A50801_TMP_UNITS_DATA_RANGE_MAX = 51;


  // Constructors ---------------------------------------------------------------------------------

  /**
   * Constructs a 'A5-08-01' EnOcean equipment profile (EEP) instance with given
   ...
   */
  public EepA50801(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(
        EepType.EEP_TYPE_A50801, deviceID, commandString,
        Range.createRange(
            ...
            EEP_A50801_ILL_UNITS_DATA_RANGE_MIN, EEP_A50801_ILL_UNITS_DATA_RANGE_MAX,
        ...
        Range.createRange(
            ...
            EEP_A50801_TMP_UNITS_DATA_RANGE_MIN, EEP_A50801_TMP_UNITS_DATA_RANGE_MAX,
