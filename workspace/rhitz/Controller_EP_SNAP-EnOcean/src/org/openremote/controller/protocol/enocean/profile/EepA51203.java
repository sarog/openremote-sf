 ...
 * </pre>
 *
 * The 'A5-12-03' profile data is transmitted by means of 4BS radio telegrams.
 ...
 * @author Rainer Hitz
 */
public class EepA51203 extends EepA512XX
{

  // Constructors ---------------------------------------------------------------------------------

  public EepA51203(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(EepType.EEP_TYPE_A51203, deviceID, commandString);
  }
}
