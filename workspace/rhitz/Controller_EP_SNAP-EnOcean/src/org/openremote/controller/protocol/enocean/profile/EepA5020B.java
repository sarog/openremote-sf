...
/**
 * Represents the EnOcean equipment profile (EEP) 'A5-02-0B'. <p>
 *
 * <pre>
 *
 *     +------+------+------------------------------------------+
 ...
 * </pre>
 *
 * The 'A5-02-0B' profile data is transmitted by means of 4BS radio telegrams.
 ...
 * @author Rainer Hitz
 */
public class EepA5020B extends EepA502XX
{
   ...
   */
  static final int EEP_A5020B_TMP_OFFSET = 16;

  /**
   * Bit size of temperature data field.
   */
  static final int EEP_A5020B_TMP_SIZE = 8;

  /**
   * Begin of raw temperature value range.
   */
  static final int EEP_A5020B_TMP_RAW_DATA_RANGE_MIN = 255;

  /**
   * End of raw temperature value range.
   */
  static final int EEP_A5020B_TMP_RAW_DATA_RANGE_MAX = 0;

  /**
   * Begin of scaled temperature value range.
   */
  static final double EEP_A5020B_TMP_UNITS_DATA_RANGE_MIN = 60;

  /**
   * End of scaled temperature value range.
   */
  static final double EEP_A5020B_TMP_UNITS_DATA_RANGE_MAX = 100;
  ...
  /**
   * Constructs a 'A5-02-0B' EnOcean equipment profile (EEP) instance with given
   ...
   */
  public EepA5020B(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(
        EepType.EEP_TYPE_A5020B, deviceID, commandString,
        Range.createRange(
            EEP_TEMPERATURE_DATA_FIELD_NAME, EEP_A5020B_TMP_OFFSET, EEP_A5020B_TMP_SIZE,
            EEP_A5020B_TMP_RAW_DATA_RANGE_MIN, EEP_A5020B_TMP_RAW_DATA_RANGE_MAX,
            EEP_A5020B_TMP_UNITS_DATA_RANGE_MIN, EEP_A5020B_TMP_UNITS_DATA_RANGE_MAX,
