...
/**
 * Represents the EnOcean equipment profile (EEP) 'A5-10-14'. <p>
 *
 * <pre>
 *
 *     +------+------+--------------------------------------------------+
 ...
 * </pre>
 *
 * The 'A5-10-14' profile data is transmitted by means of 4BS radio telegrams.
 ...
 * @author Rainer Hitz
 */
public class EepA51014 extends EepA510XX
{
   ...
   */
  static final int EEP_A51014_HUM_OFFSET = 8;

  /**
   * Bit offset of temperature data field.
   */
  static final int EEP_A51014_TMP_OFFSET = 16;

  /**
   * Bit offset of 'slide switch' data field.
   */
  static final int EEP_A51014_SLSW_OFFSET = 31;


  // Constructors ---------------------------------------------------------------------------------

  public EepA51014(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(EepType.EEP_TYPE_A51014, deviceID);

    initCommand(commandString);

    this.humidity = createHumidityRange(EEP_A51014_HUM_OFFSET);
    this.temperature = createTemperatureRange8Bit2(EEP_A51014_TMP_OFFSET);
    this.slideSwitch =  createSlideSwitchBool(EEP_A51014_SLSW_OFFSET);

    this.sensorData = new EepData(EepType.EEP_TYPE_A51014, 4, humidity, temperature, slideSwitch);
  }
