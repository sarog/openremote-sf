...
/**
 * Represents the EnOcean equipment profile (EEP) 'A5-10-12'. <p>
 *
 * <pre>
 *
 *     +------+------+---------------------------------------------+
 ...
 * </pre>
 *
 * The 'A5-10-12' profile data is transmitted by means of 4BS radio telegrams.
 ...
 * @author Rainer Hitz
 */
public class EepA51012 extends EepA510XX
{
   ...
   */
  static final int EEP_A51012_SP_OFFSET = 0;

  /**
   * Bit offset of humidity data field.
   */
  static final int EEP_A51012_HUM_OFFSET = 8;

  /**
   * Bit offset of temperature data field.
   */
  static final int EEP_A51012_TMP_OFFSET = 16;


  // Constructors ---------------------------------------------------------------------------------

  public EepA51012(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(EepType.EEP_TYPE_A51012, deviceID);

    initCommand(commandString);

    this.setPoint = createSetPointRange8Bit(EEP_A51012_SP_OFFSET);
    this.humidity = createHumidityRange(EEP_A51012_HUM_OFFSET);
    this.temperature = createTemperatureRange8Bit2(EEP_A51012_TMP_OFFSET);

    this.sensorData = new EepData(EepType.EEP_TYPE_A51012, 4, setPoint, humidity, temperature, slideSwitch);
  }
