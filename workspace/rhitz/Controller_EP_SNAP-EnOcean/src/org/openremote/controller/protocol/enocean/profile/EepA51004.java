 ...
 *     +------+------+------------------------------------------------+
 *     | TYPE |  04  |Temperature Sensor, Set Point, Fan Speed Control|
 *     +------+------+------------------------------------------------+
 *
 * </pre>
 *
 ...
 * @author Rainer Hitz
 */
public class EepA51004 extends EepA510XX
{
   ...
   */
  static final int EEP_A51004_FAN_OFFSET = 0;

  /**
   * Bit offset of 'set point' data field.
   */
  static final int EEP_A51004_SP_OFFSET = 8;

  /**
   * Bit offset of temperature data field.
   */
  static final int EEP_A51004_TMP_OFFSET = 16;


  // Constructors ---------------------------------------------------------------------------------

  public EepA51004(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(EepType.EEP_TYPE_A51004, deviceID);

    initCommand(commandString);

    this.fanSpeed = createFanSpeedRange(EEP_A51004_FAN_OFFSET);
    this.setPoint = createSetPointRange8Bit(EEP_A51004_SP_OFFSET);
    this.temperature = createTemperatureRange8Bit(EEP_A51004_TMP_OFFSET);

    this.sensorData = new EepData(EepType.EEP_TYPE_A51004, 4, fanSpeed, setPoint, temperature);
  }
