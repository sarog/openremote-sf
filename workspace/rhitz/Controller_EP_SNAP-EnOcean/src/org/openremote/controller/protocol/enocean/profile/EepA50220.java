...
/**
 * Represents the EnOcean equipment profile (EEP) 'A5-02-20'. <p>
 *
 * <pre>
 *
 *     +------+------+-------------------------------------------+
 ...
 *     +------+------+-------------------------------------------+
 *     | TYPE |  20  | Temperature Sensor Range -10°C to +41.2°C |
 *     +------+------+-------------------------------------------+
 *
 * </pre>
 *
 * The 'A5-02-20' profile data is transmitted by means of 4BS radio telegrams.
 ...
 *     +----------------------------------------------------------------------------------------------+
 *     |16    |8   |DB1.7..DB1.0|Temperature|  TMP   |Temperature(linear)|  255..0   |-10..+41.2 |°C  |
 *     +----------------------------------------------------------------------------------------------+
 ...
 * @author Rainer Hitz
 */
public class EepA50220 extends EepA502XX
{
   ...
   */
  static final int EEP_A50220_TMP_OFFSET = 14;

  /**
   * Bit size of temperature data field.
   */
  static final int EEP_A50220_TMP_SIZE = 10;

  /**
   * Begin of raw temperature value range.
   */
  static final int EEP_A50220_TMP_RAW_DATA_RANGE_MIN = 1023;

  /**
   * End of raw temperature value range.
   */
  static final int EEP_A50220_TMP_RAW_DATA_RANGE_MAX = 0;

  /**
   * Begin of scaled temperature value range.
   */
  static final double EEP_A50220_TMP_UNITS_DATA_RANGE_MIN = -10;

  /**
   * End of scaled temperature value range.
   */
  static final double EEP_A50220_TMP_UNITS_DATA_RANGE_MAX = 41.2;
  ...
  /**
   * Constructs a 'A5-02-20' EnOcean equipment profile (EEP) instance with given
   ...
   */
  public EepA50220(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(
        EepType.EEP_TYPE_A50220, deviceID, commandString,
        Range.createRange(
            EEP_TEMPERATURE_DATA_FIELD_NAME, EEP_A50220_TMP_OFFSET, EEP_A50220_TMP_SIZE,
            EEP_A50220_TMP_RAW_DATA_RANGE_MIN, EEP_A50220_TMP_RAW_DATA_RANGE_MAX,
            EEP_A50220_TMP_UNITS_DATA_RANGE_MIN, EEP_A50220_TMP_UNITS_DATA_RANGE_MAX,
