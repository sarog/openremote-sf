...
/**
 * Represents the EnOcean equipment profile (EEP) 'A5-10-09'. <p>
 *
 * <pre>
 *
 *     +------+------+---------------------------------------------------+
 ...
 * </pre>
 *
 * The 'A5-10-09' profile data is transmitted by means of 4BS radio telegrams.
 ...
 * @author Rainer Hitz
 */
public class EepA51009 extends EepA510XX
{
   ...
   */
  static final int EEP_A51009_FAN_OFFSET = 0;

  /**
   * Bit offset of temperature data field.
   */
  static final int EEP_A51009_TMP_OFFSET = 16;

  /**
   * Bit offset of slide switch data field.
   */
  static final int EEP_A51009_SLSW_OFFSET = 31;


  // Constructors ---------------------------------------------------------------------------------

  public EepA51009(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(EepType.EEP_TYPE_A51009, deviceID);

    initCommand(commandString);

    this.fanSpeed = createFanSpeedRange(EEP_A51009_FAN_OFFSET);
    this.temperature = createTemperatureRange8Bit(EEP_A51009_TMP_OFFSET);
    this.slideSwitch = createSlideSwitchBool(EEP_A51009_SLSW_OFFSET);

    this.sensorData = new EepData(EepType.EEP_TYPE_A51009, 4, fanSpeed, setPoint, temperature, slideSwitch);
  }
