...
/**
 * Represents the EnOcean equipment profile (EEP) 'A5-10-07'. <p>
 *
 * <pre>
 *
 *     +------+------+-------------------------------------+
 ...
 * </pre>
 *
 * The 'A5-10-07' profile data is transmitted by means of 4BS radio telegrams.
 ...
 * @author Rainer Hitz
 */
public class EepA51007 extends EepA510XX
{
   ...
   */
  static final int EEP_A51007_FAN_OFFSET = 0;

  /**
   * Bit offset of temperature data field.
   */
  static final int EEP_A51007_TMP_OFFSET = 16;


  // Constructors ---------------------------------------------------------------------------------

  public EepA51007(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(EepType.EEP_TYPE_A51007, deviceID);

    initCommand(commandString);

    this.fanSpeed = createFanSpeedRange(EEP_A51007_FAN_OFFSET);
    this.temperature = createTemperatureRange8Bit(EEP_A51007_TMP_OFFSET);

    this.sensorData = new EepData(EepType.EEP_TYPE_A51007, 4, fanSpeed, temperature);
  }
