...
/**
 * Represents the EnOcean equipment profile (EEP) 'A5-02-0A'. <p>
 *
 * <pre>
 *
 *     +------+------+-----------------------------------------+
 ...
 * </pre>
 *
 * The 'A5-02-0A' profile data is transmitted by means of 4BS radio telegrams.
 ...
 *     +---------------------------------------------------------------------------------------------+
 *     |16    |8   |DB1.7..DB1.0|Temperature|  TMP   |Temperature(linear)|  255..0   | +50..+90 |°C  |
 *     +---------------------------------------------------------------------------------------------+
 ...
 * @author Rainer Hitz
 */
public class EepA5020A extends EepA502XX
{
   ...
   */
  static final int EEP_A5020A_TMP_OFFSET = 16;

  /**
   * Bit size of temperature data field.
   */
  static final int EEP_A5020A_TMP_SIZE = 8;

  /**
   * Begin of raw temperature value range.
   */
  static final int EEP_A5020A_TMP_RAW_DATA_RANGE_MIN = 255;

  /**
   * End of raw temperature value range.
   */
  static final int EEP_A5020A_TMP_RAW_DATA_RANGE_MAX = 0;

  /**
   * Begin of scaled temperature value range.
   */
  static final double EEP_A5020A_TMP_UNITS_DATA_RANGE_MIN = 50;

  /**
   * End of scaled temperature value range.
   */
  static final double EEP_A5020A_TMP_UNITS_DATA_RANGE_MAX = 90;
  ...
  /**
   * Constructs a 'A5-02-0A' EnOcean equipment profile (EEP) instance with given
   ...
   */
  public EepA5020A(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(
        EepType.EEP_TYPE_A5020A, deviceID, commandString,
        Range.createRange(
            EEP_TEMPERATURE_DATA_FIELD_NAME, EEP_A5020A_TMP_OFFSET, EEP_A5020A_TMP_SIZE,
            EEP_A5020A_TMP_RAW_DATA_RANGE_MIN, EEP_A5020A_TMP_RAW_DATA_RANGE_MAX,
            EEP_A5020A_TMP_UNITS_DATA_RANGE_MIN, EEP_A5020A_TMP_UNITS_DATA_RANGE_MAX,
