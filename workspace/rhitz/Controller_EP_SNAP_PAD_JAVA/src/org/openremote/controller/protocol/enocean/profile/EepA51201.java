...
/**
 * Represents the EnOcean equipment profile (EEP) 'A5-12-01'. <p>
 *
 * <pre>
 *
 *     +------+------+-----------------------------+
 ...
 * </pre>
 *
 * The 'A5-12-01' profile data is transmitted by means of 4BS radio telegrams.
 ...
 *     +-------------------------------------------------------------------------------------------------+
 *     |0     |24  |DB3.7..DB1.0|Meter Reading |   MR   |Current value in W  |0..16777215|according |see |
 *     |      |    |            |              |        |or cumulative value |           |to DIV    |DT  |
 *     |      |    |            |              |        |in kWh              |           |          |    |
 *     +-------------------------------------------------------------------------------------------------+
 ...
 * @author Rainer Hitz
 */
public class EepA51201 extends EepA512XX
{

  // Constructors ---------------------------------------------------------------------------------

  public EepA51201(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(EepType.EEP_TYPE_A51201, deviceID, commandString);
  }
}
