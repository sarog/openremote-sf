...
/**
 * Represents the EnOcean equipment profile (EEP) 'A5-10-03'. <p>
 *
 * <pre>
 *
 *     +------+------+-------------------------------------+
 ...
 * </pre>
 *
 * The 'A5-10-03' profile data is transmitted by means of 4BS radio telegrams.
 ...
 * @author Rainer Hitz
 */
public class EepA51003 extends EepA510XX
{
   ...
   */
  static final int EEP_A51003_SP_OFFSET = 8;

  /**
   * Bit offset of temperature data field.
   */
  static final int EEP_A51003_TMP_OFFSET = 16;


  // Constructors ---------------------------------------------------------------------------------

  public EepA51003(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(EepType.EEP_TYPE_A51003, deviceID);

    initCommand(commandString);

    this.setPoint = createSetPointRange8Bit(EEP_A51003_SP_OFFSET);
    this.temperature = createTemperatureRange8Bit(EEP_A51003_TMP_OFFSET);

    this.sensorData = new EepData(EepType.EEP_TYPE_A51003, 4, setPoint, temperature);
  }
