...
/**
 * Represents the EnOcean equipment profile (EEP) 'A5-02-30'. <p>
 *
 * <pre>
 *
 *     +------+------+-------------------------------------------+
 ...
 *     +------+------+-------------------------------------------+
 *     | TYPE |  30  | Temperature Sensor Range -40°C to +62.3°C |
 *     +------+------+-------------------------------------------+
 *
 * </pre>
 *
 * The 'A5-02-30' profile data is transmitted by means of 4BS radio telegrams.
 ...
 *     +----------------------------------------------------------------------------------------------+
 *     |16    |8   |DB1.7..DB1.0|Temperature|  TMP   |Temperature(linear)|  255..0   |-40..+62.3 |°C  |
 *     +----------------------------------------------------------------------------------------------+
 ...
 * @author Rainer Hitz
 */
public class EepA50230 extends EepA502XX
{
   ...
   */
  static final int EEP_A50230_TMP_OFFSET = 14;

  /**
   * Bit size of temperature data field.
   */
  static final int EEP_A50230_TMP_SIZE = 10;

  /**
   * Begin of raw temperature value range.
   */
  static final int EEP_A50230_TMP_RAW_DATA_RANGE_MIN = 1023;

  /**
   * End of raw temperature value range.
   */
  static final int EEP_A50230_TMP_RAW_DATA_RANGE_MAX = 0;

  /**
   * Begin of scaled temperature value range.
   */
  static final double EEP_A50230_TMP_UNITS_DATA_RANGE_MIN = -40;

  /**
   * End of scaled temperature value range.
   */
  static final double EEP_A50230_TMP_UNITS_DATA_RANGE_MAX = 62.3;
  ...
  /**
   * Constructs a 'A5-02-30' EnOcean equipment profile (EEP) instance with given
   ...
   */
  public EepA50230(DeviceID deviceID, String commandString) throws ConfigurationException
  {
    super(
        EepType.EEP_TYPE_A50230, deviceID, commandString,
        Range.createRange(
            EEP_TEMPERATURE_DATA_FIELD_NAME, EEP_A50230_TMP_OFFSET, EEP_A50230_TMP_SIZE,
            EEP_A50230_TMP_RAW_DATA_RANGE_MIN, EEP_A50230_TMP_RAW_DATA_RANGE_MAX,
            EEP_A50230_TMP_UNITS_DATA_RANGE_MIN, EEP_A50230_TMP_UNITS_DATA_RANGE_MAX,
