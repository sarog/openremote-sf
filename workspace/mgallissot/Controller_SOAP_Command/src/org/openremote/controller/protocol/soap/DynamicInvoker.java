...
public class DynamicInvoker {
   ...
   public HashMap invokeMethod(String operationName, String portName, HashMap args, int timeout) throws Exception {
      ...
      if (inNames.size() != args.size()) throw new RuntimeException("Need " + inNames.size() + " arguments!!!");

      for (int pos = 0; pos < inNames.size(); ++pos) {
         //String arg = args[pos];
         Parameter p = (Parameter) inTypes.get(pos);
         String arg = (String) args.get(p.getName());
