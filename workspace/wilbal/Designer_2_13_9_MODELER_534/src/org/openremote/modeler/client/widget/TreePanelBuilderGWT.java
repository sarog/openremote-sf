 ...
 */
public class TreePanelBuilderGWT {

   /**
    * Not be instantiated.
    */
   private TreePanelBuilderGWT() {
   }
   ...
   public static TreePanel<BeanModel> buildDeviceCommandTree() {
      ...
      RpcProxy<List<DeviceDTO>> loadDeviceRPCProxy = new RpcProxy<List<DeviceDTO>>() {
         @Override
         protected void load(Object o,final AsyncCallback<List<DeviceDTO>> listAsyncCallback) {
