...
public class DSCIT100CommandBuilderTest {
   ...
   /**
    * Test DSCIT100 command parsing with "ARM_AWAY" as the command string and 1.1.1.1:5000 address, partition 1 and
    * security code 1234.
    */
   @Test
   ...
   /**
    * Test DSCIT100 command parsing with "ARM_STAY" as the command string and 1.1.1.1:5000 address, partition 1 and
    * security code 1234.
    */
   @Test
   ...
   /**
    * Test DSCIT100 command parsing with "ARM_NO_ENTRY_DELAY" as the command string and 1.1.1.1:5000 address, partition
    * 1 and security code 1234.
    */
   @Test
   ...
   /**
    * Test DSCIT100 command parsing with "ARM" as the command string and 1.1.1.1:5000 address, partition 1 and security
    * code 1234.
    */
   @Test
   ...
   /**
    * Test DSCIT100 command parsing with "DISARM" as the command string and 1.1.1.1:5000 address, partition 1 and
    * security code 1234.
    */
   @Test
   ...
   /**
    * Test DSCIT100 command parsing with "PANIC_FIRE" as the command string and 1.1.1.1:5000 address.
    */
   @Test
   ...
   /**
    * Test DSCIT100 command parsing with "PANIC_AMBULANCE" as the command string and 1.1.1.1:5000 address.
    */
   @Test
   ...
   /**
    * Test DSCIT100 command parsing with "PANIC_POLICE" as the command string and 1.1.1.1:5000 address.
    */
   @Test
   ...
   /**
    * Test DSCIT100 command parsing with "PARTITION_STATE" as the command string and 1.1.1.1:5000 address and partition
    * 1.
    */
   @Test
   ...
   /**
    * Test DSCIT100 command parsing with XML snippets containing superfluous properties.
    */
   @Test
   ...
   private Command getCommand(String cmd, String address, String target, String code) {
      ...
      propAddr.setAttribute(CommandBuilder.XML_ATTRIBUTENAME_NAME, DSCIT100CommandBuilder.DSCIT100_XMLPROPERTY_ADDRESS);
      ...
      propAddr2
            .setAttribute(CommandBuilder.XML_ATTRIBUTENAME_NAME, DSCIT100CommandBuilder.DSCIT100_XMLPROPERTY_COMMAND);
      ...
      propAddr3.setAttribute(CommandBuilder.XML_ATTRIBUTENAME_NAME, DSCIT100CommandBuilder.DSCIT100_XMLPROPERTY_CODE);
      ...
      propAddr4.setAttribute(CommandBuilder.XML_ATTRIBUTENAME_NAME, DSCIT100CommandBuilder.DSCIT100_XMLPROPERTY_TARGET);
