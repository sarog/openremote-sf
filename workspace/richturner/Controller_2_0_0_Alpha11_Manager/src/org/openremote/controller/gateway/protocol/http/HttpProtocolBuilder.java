...
/**
 * The Class HttpProtocolBuilder.
 *
 * @author Rich Turner 2011-04-10
 */
public class HttpProtocolBuilder implements ProtocolBuilder {
   ...
   public Protocol build(Element element) {
      ...
      for(Element ele : propertyEles){
         ...
         } else if("method".equalsIgnoreCase(ele.getAttributeValue("name"))){
            protocol.setMethod(ele.getAttributeValue("value"));
         } else if("contenttype".equalsIgnoreCase(ele.getAttributeValue("name"))){
            protocol.setContentType(ele.getAttributeValue("value"));
         }
      }
      return protocol;
   }
