...
public class RangeSensor extends Sensor
{
  ...
  public RangeSensor(String name, int sensorID, EventProducer eventProducer, int min, int max)
  {
    this(name, sensorID, EnumSensorType.RANGE, eventProducer, min, max, true);

  }

  protected RangeSensor(String name, int sensorID, EnumSensorType type,
                        EventProducer producer, int min, int max, boolean setDefaultProps)
  {
    super(name, sensorID, type, producer, createDefaultProperties(setDefaultProps, min, max));
