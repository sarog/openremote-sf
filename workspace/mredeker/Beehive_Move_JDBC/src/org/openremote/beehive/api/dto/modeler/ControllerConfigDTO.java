...
public class ControllerConfigDTO extends BusinessEntityDTO {
   ...
   public ControllerConfig toControllerConfig() {
      ...
      controllerConfig.setOid(getId());
      controllerConfig.setName(name);
      controllerConfig.setValue(value);
      controllerConfig.setCategory(category);
