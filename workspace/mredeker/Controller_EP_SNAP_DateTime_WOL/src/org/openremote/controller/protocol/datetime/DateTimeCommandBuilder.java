...
/**
 * CommandBuilder implementation to create DateTime commands. DateTime commands can be used to display date or time on the console
...
//
//     if (null == timezone || null == longitude || null == latitude)
//     {
//         logger.warn("Unable to create DateTime command for sunrise/sunset related command, missing configuration parameter(s)");
//         return null;
//     }
