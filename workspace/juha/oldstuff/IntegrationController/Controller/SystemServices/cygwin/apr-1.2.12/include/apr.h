...
// ------------------------------------------------------------------------------------------------
//
//  See the comment above -- these don't belong here and in fact cause a conflict with the Cygwin
//  environment that has these defined in /usr/include/cygwin/types.h   (juha)
//
//
//typedef  int         uid_t;
//typedef  int         gid_t;
