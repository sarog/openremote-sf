...
//    }
    ...
    public Command build(Element element)
    {
        ...
        for (Element e : propertyElements)
        {
            ...
            //{
            if (protegePropertyName.toLowerCase().equalsIgnoreCase(PROTEGE_XMLPROPERTY_LOGIN_PIN))
            {                
            ...
            else if (protegePropertyName.toLowerCase().equalsIgnoreCase(PROTEGE_XMLPROPERTY_LOGIN_TIMEOUT))
            {        
            ...
            else if (protegePropertyName.toLowerCase().equalsIgnoreCase(PROTEGE_XMLPROPERTY_RECORD_VALUE))
            {        
            ...
            else if (protegePropertyName.toLowerCase().equalsIgnoreCase(PROTEGE_XMLPROPERTY_RECORD_COMMAND))
            {        
            ...
            else if (protegePropertyName.toLowerCase().equalsIgnoreCase(PROTEGE_XMLPROPERTY_RECORD_TYPE))
            {        
            ...
            else if (protegePropertyName.toLowerCase().equalsIgnoreCase(PROTEGE_XMLPROPERTY_RECORD_INDEX))
            {        
