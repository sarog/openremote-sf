...
public class DeployerTest
{
  ...
  public static Deployer createDeployer(URI resourcePath) throws InitializationException
  {
...
//    Set<ObjectBuilder<?, Version20ModelBuilder.XMLSegment, Version20ModelBuilder>> objectBuilders =
//        new HashSet<ObjectBuilder<?, Version20ModelBuilder.XMLSegment, Version20ModelBuilder>>();
//
//    objectBuilders.add(sensorBuilder);
...
//    cf.setCommandBuilders(p);
  ...
  // Test ObjectBuilder Registrations -------------------------------------------------------------

//  /**
//   *
//   * @throws Exception
//   */
//  @Test public void testRegisterOB() throws Exception
//  {
//    StatusCache cache = new StatusCache();
//    ControllerConfiguration config = new ControllerConfiguration();
//
...
//
//    ModelBuilder modelBuilder = new Version20ModelBuilder(cache, config, objectBuilders);
//
//    //Map<String, ModelBuilder> builders = new HashMap<String, ModelBuilder>();
//    //builders.put(ModelBuilder.SchemaVersion.VERSION_2_0.toString(), modelBuilder);
//
//    //Deployer d = new Deployer(deployerName, new StatusCache(), new ControllerConfiguration(), builders);
//
//    Assert.assertTrue(ob.getModelBuilder() == modelBuilder);
//  }
//
...
//    ModelBuilder modelBuilder = new Version20ModelBuilder(cache, config, objectBuilders);
//
//    Assert.assertTrue(ob.getModelBuilder() == null);
//
//  }
...
//
//
//    Element sensors = d.queryElementByName(Version20ModelBuilder.XMLSegment.SENSORS);
//
...
//    try
//    {
//      d.queryElementByName(Version20ModelBuilder.XMLSegment.SLIDER);
//
//      Assert.fail("should not get here");
//    }
...
//  }
  ...
  private static class TestOB //extends ObjectBuilder<Object, Version20ModelBuilder.XMLSegment, Version20ModelBuilder>
  {
...
//    }
//
//    @Override public Version20ModelBuilder.XMLSegment getRootSegment()
//    {
//      return Version20ModelBuilder.XMLSegment.SENSORS;
//    }
//
//    @Override public ModelBuilder.SchemaVersion getSchemaVersion()
//    {
