...
/**
 * Ad2Usb Wizard Window to create a new Ad2Usb device, including all commands, sensors, sliders and switches.
 * 
 * @author Craig
 */
public class Ad2UsbWizardWindow extends WizardWindow {
    ...
    */
   public Ad2UsbWizardWindow() {
      super(null);
      setHeading("New Ad2Usb Device");
      show();
   }
