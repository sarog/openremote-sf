...
/**
 * Command builder for the ISY-99 protocol, which communicates with the Universal Devices ISY-99 Insteon-to-HTTP bridge.
 * 
...
public class Isy99CommandBuilder implements CommandBuilder {
   ...
   /**
    * A common log category name intended to be used across all classes related to ISY-99 implementation.
    */
    ...
    * @param username
    *           username for authentication to the ISY-99
    * @param password
    *           password for authentication to the ISY-99
    */
    ...
    * 
    * 
    * For reading a device's status, the "command" property can be set to whatever you want -- it will be ignored.
    * 
    ...
    *            if the ISY-99 command instance cannot be constructed from the XML snippet for any reason
    * 
    * @return an immutable ISY-99 command instance with known configured properties set
    */
   @Override
   public Command build(Element element) {
      ...
      for (Element el : propertyElements) {
         ...
         if (ISY99_XMLPROPERTY_ADDRESS.equalsIgnoreCase(propertyName)) {
            ...
            log.warn("Unknown ISY-99 property '<" + XML_ELEMENT_PROPERTY + " " + XML_ATTRIBUTENAME_NAME + " = \""
