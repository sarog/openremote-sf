...
public class ElexolCommandBuilder implements CommandBuilder
{
  ...
  public Command build(Element element)
  {
	...
	pulseDuration = commandPropertyValue;
      ...
      {
	log.warn("Unknown Elexol USB property '<" + XML_ELEMENT_PROPERTY + " " +
    ...
    {
      throw new NoSuchCommandException("Elexol USB command is missing a mandatory '" 
				       + ELEXOL_USB_XMLPROPERTY_USB_PORT 
				       + "' property"
				       );
    }
    ...
    {
      throw new NoSuchCommandException("Elexol USB command is missing a mandatory '" 
				       + ELEXOL_USB_XMLPROPERTY_IO_PORT 
				       + "' property"
				       );
    }
    ...
    {
      throw new NoSuchCommandException("Elexol USB command is missing a mandatory '" 
				       + ELEXOL_USB_XMLPROPERTY_PIN_NUMBER 
				       + "' property"
				       );
    }
    ...
    {
      throw new NoSuchCommandException("Elexol USB command is missing a mandatory '" 
				       + ELEXOL_USB_XMLPROPERTY_COMMAND 
				       + "' property"
				       );
    }
    ...
    {
      throw new NoSuchCommandException("Elexol USB command '" 
				       + commandString 
				       + "' is not recognized.");
    }
    ...
    {
      throw new NoSuchCommandException("Elexol USB I/O port '" 
				       + ioPort 
				       + "' is not recognized.");
    }
