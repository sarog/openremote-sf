...
public class DoorLock extends VeraDevice {
   ...
   public void turnOn() {
      ...
      cmdUrl.append(id);
      cmdUrl.append("&serviceId=urn:micasaverde-com:serviceId:DoorLock1&action=SetTarget&newTargetValue=1");
   ...
   public void turnOff() {
      ...
      cmdUrl.append(":3480/data_request?id=lu_action&output_format=xml&DeviceNum=");
      cmdUrl.append(id);
      cmdUrl.append("&serviceId=urn:micasaverde-com:serviceId:DoorLock1&action=SetTarget&newTargetValue=0");
      getClient().sendCommand(cmdUrl.toString());
   }
