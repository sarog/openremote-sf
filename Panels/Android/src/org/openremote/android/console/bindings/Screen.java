...
/**
 * Screen is used by the binding api to parse the XML file, each Activity contains a collection of Screens.  These are used by ActivityHandler to
 * configure a set of screens.  Screens correspond to Views in Android terminology.  Screens contain buttons.
 * This class conforms to the rules required by SimpleBinder.  ORScreen is an interface included for consistency since Activity and Button have
 * similar interfaces, there is no need to use ORScreen.
 *    
